...
export const CAR_SERVICES = [
  ...
  {
    id: "mantenimiento-interior-cojineria",
    category: "car",
    name: "Mantenimiento Interior Sólo Cojinería",
    price: 290000,
    priceDisplay: "$290.000",
    time: "2 días",
    durationHours: 16,
    description: "Lavado esencial + lavada de sillas, lavada del techo y limpieza y aspirada de carteras.",
    why: "Ideal cuando la cojinería necesita atención especial sin levantar el alfombrado.",
  },
  {
    id: "mantenimiento-interior-alfombrado",
    category: "car",
    name: "Mantenimiento Interior Levantamiento del Alfombrado",
    price: 350000,
    priceDisplay: "$350.000",
    time: "2 días",
    durationHours: 16,
    description: "Lavado esencial + desmonte del alfombrado, lavada de sillas, lavada del techo y limpieza y aspirada de carteras.",
    why: "El tratamiento más completo para un interior impecable desde adentro hacia afuera.",
  },
  {
    id: "lavado-chasis",
    category: "car",
