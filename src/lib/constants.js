...
export const TRANSFORMATIONS = [
  ...
  },
  {
    before: "/antes-2.jpg",
    after: "/despues-2.jpg",
    label: "Land Cruiser — Tratamiento 3 en 1 Manual",
    tag: "TRATAMIENTO 3 EN 1 MANUAL",
    price: "$290.000",
    desc: "Descontaminación profunda, corrección de brillo manual y sellado cerámico. Triple intervención en una sola sesión para devolver la vida a la pintura.",
    process: [
      "Lavado de chasis y guardabarros con hidrolavadora industrial",
      "Descontaminación especializada para barro seco y salpicaduras",
      "Corrección manual de brillo con compound profesional",
      "Sellado cerámico con cera de protección de alta durabilidad",
    ],
  },
  {
    before: "/antes-3.jpg",
