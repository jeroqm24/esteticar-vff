            ...
            <AnimatePresence>
              {visible && (
                <motion.button
                  ...
                  className="group absolute bottom-[5.5rem] left-1/2 -translate-x-1/2 z-20 flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-ec-gold text-white font-ui text-[10px] tracking-[0.2em] uppercase shadow-[0_6px_24px_rgba(184,134,11,0.5)] hover:shadow-[0_10px_32px_rgba(184,134,11,0.6)] whitespace-nowrap"
