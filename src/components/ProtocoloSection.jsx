      ...
      >
        ...
        >
          ...
          <div className="p-6 sm:p-8 border-t border-black/[0.06] flex flex-col sm:flex-row gap-3">
            <a
              href={`https://wa.me/573181983601?text=${encodeURIComponent("Hola 👋 acabo de revisar la garantía de custodia de $5.000.000 COP en la página de Esteticar y me genera mucha confianza.\n\nMe gustaría agendar una cita. ¿Qué disponibilidad tienen esta semana?")}`}
              target="_blank"
