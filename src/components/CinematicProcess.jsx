...
function ProcessStep({ step, index, scrollYProgress }) {
  ...
  return (
    <motion.div style={{ opacity, y }}
      ...
      <div className="absolute top-[70vh] inset-x-0 flex flex-col items-center text-center px-6 gap-3">
    ...
    <div ref={containerRef} style={{ height: "520vh", position: "relative" }}>
      <div style={{ position: "sticky", top: 0, height: "100dvh", overflow: "hidden", background: "#040404" }}>
        ...
        <motion.div style={{ opacity: heroOpacity }}
          ...
          <div className="absolute top-[70vh] inset-x-0 flex flex-col items-center text-center px-6 gap-3 sm:gap-4">
