...
export default function CinematicProcess() {
  ...
  return (
    <div ref={containerRef} style={{ height: "520vh", position: "relative" }}>
      <div style={{ position: "sticky", top: 0, height: "100dvh", overflow: "hidden", background: "#060606" }}>
        ...
        <motion.div style={{ opacity: heroOpacity }}
          ...
          <img src={BRAND.logo} alt="Esteticar"
            ...
            style={{ filter: "drop-shadow(0 0 40px rgba(248,200,64,0.3)) drop-shadow(0 0 80px rgba(248,200,64,0.12))" }}
          />
          ...
          <a href="#servicios"
            ...
            style={{ background: "linear-gradient(135deg, #B8860B 0%, #D4A017 100%)", boxShadow: "0 4px 28px rgba(184,134,11,0.4), inset 0 1px 0 rgba(255,255,255,0.15)" }}>
        ...
        <motion.div style={{ opacity: afterLabelOpacity }}
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full"
            style={{ background: "linear-gradient(135deg, rgba(184,134,11,0.92), rgba(212,160,23,0.92))", boxShadow: "0 4px 28px rgba(184,134,11,0.45)", backdropFilter: "blur(8px)" }}>
