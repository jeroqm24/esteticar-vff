    ...
    >
      ...
      >
        ...
        <div className="flex justify-end mt-1 gap-1 items-center">
          ...
          {isUser && (
            <svg viewBox="0 0 16 15" width="16" height="15" className="shrink-0 ml-0.5 mt-0.5">
              <path fill="#53bdeb" d="M15.01 3.316l-.478-.372a.365.365 0 0 0-.51.063L8.666 9.879a.32.32 0 0 1-.484.033l-.358-.325a.319.319 0 0 0-.484.032l-.378.483a.418.418 0 0 0 .036.541l1.32 1.266c.143.14.346.125.467-.025l6.236-8.034a.365.365 0 0 0-.012-.534zm-8.22 3.01H6.757a.384.384 0 0 1-.502-.054L2.83 2.919A.384.384 0 0 0 2.298 2.87L1.862 3.29a.384.384 0 0 0-.01.534l4.634 4.88c.135.14.342.148.487.01l1.042-1.026c.14-.136.148-.352.016-.487l-.46-.446a.384.384 0 0 0-.52-.023H6.79zm5.558 3.522l-4.7-6.246a.384.384 0 0 0-.55-.072l-.466.368a.382.382 0 0 0-.063.518l4.425 5.86a.294.294 0 0 0 .428.056l.85-.68a.382.382 0 0 0 .076-.518V9.848z" />
            </svg>
          )}
        </div>
      </div>
